        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {articles.map((story) => (
            <article
              ...
              className="bg-[#FAFBFC] border border-[#E3E8F1] rounded-xl overflow-hidden p-4 flex flex-col justify-between group cursor-pointer hover:border-[#1E5EFF] transition-all shadow-sm"
            >
              <div>
                ...
                <div className="flex items-center justify-between text-[11px] mb-2">
                  <span className="font-bold text-[#1E5EFF] uppercase tracking-wider">
                    {story.category}
                  </span>
